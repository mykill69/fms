...
@section('content')
    <div x-data="dashboard()" x-init="init()" x-cloak class="dashboard-bg min-h-screen p-3 sm:p-4 md:p-5 lg:p-6">
        ...
        <div
            ...
            <div>
                <h1 class="text-xl sm:text-2xl font-semibold tracking-tight text-gray-800 flex items-center gap-2">
                    LISTEN
                    <span class="text-sm font-normal text-gray-400">Feedback Intelligence Dashboard</span>
                </h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 mt-4">
            ...
            <div class="lg:col-span-4 modern-card bg-white rounded-2xl p-4">
                <h6 class="text-base font-semibold mb-3 text-left">Concerning Offices</h6>
                <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
            <div class="modern-card bg-white rounded-2xl p-4">
                <h6 class="text-base font-semibold mb-3">Top Recurring Concerns</h6>
                <div class="space-y-4">
                    <template x-for="(item, index) in aiInsights.filter(i => i.priority !== 'positive')"
                        ...
                        <div class="flex gap-3">
                            <div class="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold"
                                :class="{
                                    ...
                                    'bg-amber-100 text-amber-700': index === 1,
                                    'bg-yellow-100 text-yellow-700': index === 2,
                                    'bg-gray-100 text-gray-600': index > 2
                                }">
                                <span x-text="index + 1"></span>
                            </div>
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-800" x-text="item.issue || item.title"></p>
                                <div class="mt-2 h-5 bg-slate-100 rounded-full overflow-hidden">
                                    <div :class="progressColor(item.priority)"
                            ...
                            <div class="text-right flex-shrink-0">
                                <span class="text-lg font-bold"
                                    :class="{
                                        'text-red-600': item.priority === 'critical',
                                        'text-red-500': item.priority === 'high',
                                        'text-amber-500': item.priority === 'medium',
                                        'text-yellow-500': item.priority === 'low'
                                    }"
                                    x-text="item.count || 1"></span>
                                <span class="text-xs text-gray-400 block">mentions</span>
                            </div>
                        </div>
                    </template>
                    <template x-if="aiInsights.filter(i => i.priority !== 'positive').length === 0">
                        <div class="text-center py-6">
                            <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2">
                                <i class="fas fa-check-circle text-green-500 text-xl"></i>
                            </div>
                            <p class="text-gray-500 text-sm font-medium">No concerns detected</p>
                            <p class="text-gray-400 text-xs mt-1">All feedback appears positive</p>
                        </div>
                    </template>
                </div>
            </div>
            <div class="modern-card bg-white rounded-2xl p-2">
                <h6 class="text-base font-semibold mb-3">AI-generated Insights</h6>
