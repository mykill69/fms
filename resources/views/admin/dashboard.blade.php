        ...
        function dashboard() {
            return {
                ...
                async checkForUpdates() {
                    ...
                    try {
                        const res = await fetch(`/admin/dashboard/poll?last_id=${this.lastId}`);
                ...
                refreshDashboardData() {
                    ...
                    let url = '/admin/dashboard/data?fresh=1';
                ...
                async load(forceFresh = false) {
                    ...
                    try {
                        let url = forceFresh ? '/admin/dashboard/data?fresh=1' : '/admin/dashboard/data';
