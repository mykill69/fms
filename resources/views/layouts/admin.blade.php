...
<body class="bg-gray-50 overflow-x-hidden">
    ...
    <div x-data="{
        ...
        <!-- SIDEBAR -->
        <aside class="fixed lg:sticky top-0 left-0 z-40 h-screen w-72 lg:w-80 bg-gradient-to-b from-gray-900 to-gray-800 text-white
            ...
            <div class="flex-shrink-0 flex items-center gap-3 py-5 px-5 border-b border-gray-700/50">
                ...
                <div class="flex-1">
                    <h1 class="text-sm lg:text-base font-bold leading-tight bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                        CPSU Feedback
                    </h1>
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto scrollbar-thin">
                ...
                <a href="/admin/dashboard"
                   ...
                   class="flex items-center gap-3 px-4 py-3 lg:py-3.5 rounded-r-lg transition-all duration-200 group">
                    <div class="w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center flex-shrink-0"
                         :class="active === 'admin/dashboard' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-gray-300'">
                ...
                <a href="/admin/feedbacks"
                   ...
                   class="flex items-center gap-3 px-4 py-3 lg:py-3.5 rounded-r-lg transition-all duration-200 group">
                    <div class="w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center flex-shrink-0"
                         :class="active === 'admin/feedbacks' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-gray-300'">
                ...
                <a href="/admin/reports"
                   ...
                   class="flex items-center gap-3 px-4 py-3 lg:py-3.5 rounded-r-lg transition-all duration-200 group">
                    <div class="w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center flex-shrink-0"
                         :class="active === 'admin/reports' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-gray-300'">
                ...
                <a href="/admin/analysis"
                   ...
                   class="flex items-center gap-3 px-4 py-3 lg:py-3.5 rounded-r-lg transition-all duration-200 group">
                    <div class="w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center flex-shrink-0"
                         :class="active === 'admin/analysis' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-gray-300'">
                        <i class="fas fa-brain text-base lg:text-lg"></i>
                    </div>
                    <span class="font-medium text-sm lg:text-base">AI Analysis</span>
                    <span class="ml-auto px-2 py-0.5 text-[10px] font-bold bg-purple-500/20 text-purple-400 rounded-full">NEW</span>
                </a>
                ...
                <a href="/admin/offices"
                   ...
                   class="flex items-center gap-3 px-4 py-3 lg:py-3.5 rounded-r-lg transition-all duration-200 group">
                    <div class="w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center flex-shrink-0"
                         :class="active === 'admin/offices' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-gray-800 text-gray-400 group-hover:bg-gray-700 group-hover:text-gray-300'">
            ...
            <div class="flex-shrink-0 p-4 border-t border-gray-700/50 bg-gradient-to-t from-gray-900 via-gray-900 to-transparent">
                <div class="relative" x-data="{ userMenuOpen: false }">
                    <!-- User Info Button -->
                    <button @click="userMenuOpen = !userMenuOpen" 
                            class="w-full flex items-center gap-3 p-2 lg:p-3 rounded-xl hover:bg-gray-800/50 transition group">
                        <div class="relative flex-shrink-0">
                            <div class="w-10 h-10 lg:w-11 lg:h-11 rounded-xl bg-gradient-to-br from-gray-600 to-gray-700 flex items-center justify-center text-white font-semibold text-sm lg:text-base shadow-md">
                                A
                            </div>
                            <span class="absolute bottom-0 right-0 w-3 h-3 lg:w-3.5 lg:h-3.5 bg-emerald-500 border-2 border-gray-900 rounded-full"></span>
                        </div>
                        <div class="flex-1 text-left min-w-0">
                            <p class="text-sm lg:text-base font-medium text-white truncate">Administrator</p>
                            <p class="text-xs text-gray-400 truncate">admin@cpsu.edu</p>
                        </div>
                        <i class="fas fa-chevron-up text-gray-400 text-xs transition-transform flex-shrink-0" :class="{ 'rotate-180': userMenuOpen }"></i>
                    </button>
                    ...
                    <div x-show="userMenuOpen" 
                        ...
                        <div class="p-2">
                            <a href="#" class="flex items-center gap-3 px-3 py-2.5 lg:py-3 rounded-lg text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">
                            ...
                            <a href="#" class="flex items-center gap-3 px-3 py-2.5 lg:py-3 rounded-lg text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">
                                ...
                                <span class="ml-auto w-5 h-5 bg-red-500 text-white text-xs font-bold rounded-full flex items-center justify-center">3</span>
                            </a>
                            <div class="border-t border-gray-700 my-2"></div>
                            <a href="#" class="flex items-center gap-3 px-3 py-2.5 lg:py-3 rounded-lg text-sm text-red-400 hover:bg-red-500/10 hover:text-red-300 transition">
